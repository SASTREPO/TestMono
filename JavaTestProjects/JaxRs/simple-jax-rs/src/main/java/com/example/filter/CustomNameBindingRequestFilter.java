...
@Provider
@CustomMendBinding
public class CustomNameBindingRequestFilter implements ContainerRequestFilter {

    private static final Logger logger = LogManager.getLogger(CustomNameBindingRequestFilter.class);
